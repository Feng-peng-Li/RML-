    ...
    if epoch < args.warm_step:
        ...
        if epoch == args.warm_step or epoch % 1 == 0:
            ...
            if epoch < args.correction_step:
                ...
                # _, _, loss_m, label_m, label_p, tau_t, p_t, label_hist, label_update = train_correction(model, model1, train_loader,
                #                                                                              clean_targets, optimizer,
                #                                                                              optimizer2, ceriation, epoch,
                #                                                                              args.n, args.num_class, tau_t,
                #                                                                              p_t, label_hist, ema_w=0.999,
                #                                                                              label_update=label_update)
                _, _, tau_t, p_t, label_hist = train_correction(model, model1, labeled_trainloader,
                                                                unlabeled_trainloader, optimizer, optimizer2, ceriation,
                                                                epoch,
                                                                args.n, args.num_class, class_weights, tau_t, p_t,
                                                                label_hist, ema_w=0.999)
